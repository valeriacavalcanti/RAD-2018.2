...
class RegistrationsTest < ApplicationSystemTestCase
  ...
  test "creating a Registration" do
    ...
    fill_in "Matricula", with: @registration.matricula
    fill_in "Nome", with: @registration.nome
    fill_in "Senha", with: @registration.senha
    fill_in "Telefone", with: @registration.telefone
